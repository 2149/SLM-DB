...
bench_benchmarks="fillrandom,stats,waitcompaction,clean_cache,stats,readrandom,stats,waitcompaction,clean_cache,stats,scanrandom,waitcompaction,clean_cache,stats"
bench_num="20000000"
