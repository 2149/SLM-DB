...
FIND_PATH(PMDK_INCLUDE_DIR NAME libpmem.h
        HINTS /mnt/HDD/xxl/mypath/include $ENV{HOME}/local/include /opt/local/include /usr/local/include /usr/include)

FIND_LIBRARY(PMEM_LIBRARY NAME pmem
        HINTS /mnt/HDD/xxl/mypath/lib $ENV{HOME}/local/lib64 $ENV{HOME}/local/lib /usr/local/lib64 /usr/local/lib /opt/local/lib64 /opt/local/lib /usr/lib64 /usr/lib
        )
